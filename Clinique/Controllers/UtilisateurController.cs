...
namespace AspNetCoreTemplate.Controllers
{
    public class UtilisateurController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Mail,Code,Type")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Mail,Code,Type")] Utilisateur utilisateur)
        {
